...
int main() {
	...
	// Information
	cout << "--- Search Algorithms Project ---" << endl << endl;
	cout << "NAME: Alaa karsli " << endl;
	cout << "STUDENT ID: 4160039" << endl;
	cout << "E-MAIL: kar.3la2@gmail.com" << endl;
	cout << "COURSE: Intelligent Search Algorithms-spring 2022" << endl << endl;
	...
	cin >> e;
	for (int i = 0; i < e; i++){
		cout << "Enter edge first vertex:";
		cin >> a;
		cout << "Enter edge second vertex:";
		cin >> b;
		cout << "Enter edge wieght:";
		cin >> w;
		g6.addEdge(a,b,w);
	}
	cout << "Which algorithm?" << endl << "B: BFS" << endl << "D: DFS" << endl << "A: A*" << endl << "U: UCS" << endl << "C: Cancel" << endl;
	char c;
	cin >> c;
	switch (c)
	{
